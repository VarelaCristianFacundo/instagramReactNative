            ...
            <View>
                ...
                <View style={{flexDirection: "column", justifyContent: "space-between", marginVertical: 370, marginLeft: 270, position:"absolute"}}>
                    <View style={{ flexDirection: "column", alignItems: "center"}}>                        
                        <AntDesign name="hearto" size={24} color="black" style={{ marginTop: 20}} />
                        <Feather name="message-circle" size={24} color="black" style={{ marginTop: 20 }} />
                        <Feather name="send" size={24} color="black" style={{ marginTop: 20 }} />
                        <Text style={{fontWeight: "bold", marginTop: 20, color:"black"}}>{}...</Text>
                    </View>
                </View>
